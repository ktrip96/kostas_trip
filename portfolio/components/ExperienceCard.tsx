...
export default function ExperienceCard({experience}: Props) {
  return (
    <article className="flex flex-col rounded-lg items-center  space-y-7 flex-shrink-0 w-[350px] md:w-[600px] xl:w-[900px] snap-center p-10 bg-[#292929] hover:opacity-100 opacity-40 
    cursor-pointer transition-opacity duration-200 overflow-hidden pt-20">
        ...
        <div className="px-0 md:px-10 ">
            ...
            <div className="flex items-center flex-wrap  space-x-2 my-2">
                {experience.technologies.map((tech) =>                 <img className="h-8 w-8 md:h-12 md:w-12 rounded-full object-contain" src={urlFor(tech.image).url()} alt=""/>
)}
            </div>
